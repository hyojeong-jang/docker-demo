node {
  ...
  stage('Deploy') {
    ...
    sshagent(credentials: ['ec2']){
      ...
      sh "ssh -o StrictHostKeyChecking=no ubuntu@ec2-52-79-235-250.ap-northeast-2.compute.amazonaws.com 'docker run 116927014662.dkr.ecr.ap-northeast-2.amazonaws.com/helloworld:dddf480'"
    }
  }
}
